...
autoscityApp.directive('deskSidebar', function () {
    return {
        restrict: 'E',
...
autoscityApp.directive('deskPopup', function () {
    return {
        restrict: 'E',
        transclude: true,
        replace:true,
...
autoscityApp.directive("whenScrolled", function(){
    return{
...
autoscityApp.directive('fileModel', ['$parse', function ($parse) {
    return {
        restrict: 'A',
